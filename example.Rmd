...
In this case the p-value would be <.00025 (because it is based on 4000 samples; 1000 per chain that have 0 observations that would suggest that the effect is in the opposite direction that we would expect).
